...
playMove(B, Hand, NewHand, NewBoard, L) :- valid_ListMoves(B, L, Hand), apply_moves(B, L, Hand, NewHand, NewBoard).
...
game(Board,0, Hand1, Hand2, 0, 0, L):- \+done(Hand1), \+done(Hand2), playMove(Board, Hand1, NewHand, NewBoard, L),
                                     !, game(NewBoard,1, NewHand, Hand2, 1, 0, L).

game(Board,1, Hand1, Hand2, 1, 0, L):- \+done(Hand1), \+done(Hand2), playMove(Board, Hand2, NewHand, NewBoard, L),
                                     !, game(NewBoard,0, Hand1, NewHand, 0, 0, L).
...
humanHuman :-  createBoard(60,60,B), makeDeck(Deck), mixingElemtsDeck(Deck, NewDeck),
                        creatingHand(NewDeck, Hand1, Hand2), game(B, 0, Hand1, Hand2, 0, 0, L).
